...
<?php else: ?>
      ...
      <li class="nav-item<?php if ($this->request['target'] === 'auth_a' && $this->request['action'] === 'unregister'): ?> active<?php endif; ?>"><a class="nav-link" href="<?php $this->href('auth_a/unregister', ['actor' => 'm']); ?>">Unregister(a)</a></li>
      <li class="nav-item<?php if ($this->request['target'] === 'auth_a' && $this->request['action'] === 'logout'): ?> active<?php endif; ?>"><a class="nav-link" href="<?php $this->href('auth_a/logout', ['actor' => 'm']); ?>">Logout(a)</a></li>
      <li class="nav-item<?php if ($this->request['target'] === 'auth_a' && $this->request['action'] === 'change_email'): ?> active<?php endif; ?>"><a class="nav-link" href="<?php $this->href('auth_a/change_email', ['actor' => 'm']); ?>">Change Email(a)</a></li>
      <li class="nav-item<?php if ($this->request['target'] === 'auth_a' && $this->request['action'] === 'change_password'): ?> active<?php endif; ?>"><a class="nav-link" href="<?php $this->href('auth_a/change_password', ['actor' => 'm']); ?>">Change Password(a)</a></li>
<?php endif; ?>
    </ul>
  </div>
</nav>
